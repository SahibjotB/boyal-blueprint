...
export default function Hero() {
  return (
    <section id='hero' className="relative w-full min-h-screen flex flex-col justify-start pt-24 sm:pt-32 md:pt-40 items-center text-center px-4 sm:px-8 overflow-hidden">
      <h1 className="text-4xl sm:text-3xl md:text-5xl text-gray-900 dark:text-white font-display font-medium">
        Welcome to
      </h1>
      <h2 className="text-[clamp(3rem,7vw,4rem)] font-bold text-orange-500 font-display mt-2">
        Boyal Blueprint
      </h2>
